...
export const metadata: Metadata = {
  title: 'The Operational Engine | Coréal Media',
  description:
...
const data: LandingPageData = {
  ...
  testimonialQuote:
    'I used to dread Mondays — chasing the team for content, approving things last minute. Now it just runs. The Coréal team handles everything and I get a report at the end of the month.',
  testimonialAuthor: 'Multi-Brand Company Owner — Coréal Media Client',
