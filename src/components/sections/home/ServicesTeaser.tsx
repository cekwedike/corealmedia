...
import { Layers, Settings2, TrendingUp, ArrowRight } from 'lucide-react'
              ...
              <ScrollReveal key={index} delay={index * 0.15}>
                <div className="group flex flex-col gap-5 p-8 bg-bg-card border border-border rounded-sm hover:border-[rgba(139,26,26,0.4)] hover:bg-bg-elevated transition-all duration-300 h-full">
                  ...
                  <div className="mt-auto pt-4">
                    <Link
                      href="/services"
                      className="inline-flex items-center gap-2 font-body text-body-sm text-text-secondary hover:text-text-primary group-hover:gap-3 transition-all duration-200"
                    >
